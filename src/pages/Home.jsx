            ...
            <div className="text-center">
              ...
              <div className="text-center pl-2 pr-2">
                <p className="content1">
                  Our mission is to be a platform for policymakers and
                  blockchain builders to collaborate on the technical and
                  regulatory research of blockchain technologies that promote a
                  web3-friendly regulatory environment. The speed of blockchain
                  innovation is outpacing the regulatory environment and leaving
                  legislators behind in understanding and creating web3-friendly
                  regulation.
                </p>
                <br />
                <p className="content2">
                  The underlying technology propelling the blockchain will
                  continuously advance regardless of any political regulation,
                  and for us to capture the benefits of emerging and innovative
        ...
        <div className="pt-10 hidden md:flex">
          ...
          <div className="w-1/2 text-left max-w-600">
            ...
            <div className="text-left">
              <p
                style={{ color: "var(--description-color)", maxWidth: "550px" }}
              >
