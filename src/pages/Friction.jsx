      ...
      >
        ...
        <div>
          <div className="text-left mb-5 pl-10">
            <div style={{ color: "var(--subtitle)", fontWeight: "bold" }}>
              Levels to organizing public policy from the constituent’s
              perspective:
            </div>
            <ul
            ...
            >
              ...
              <li>
                Consumer to local municipalities (ie – utilities, property
                taxes)
              </li>
        ...
        <div className="text-left mb-5 pl-10">
          ...
          <ul className="list-disc pl-12" style={{ color: "var(--subtitle)" }}>
            ...
            >
              <li>
                Barriers to Learn (ie – no mandatory quarterly financial
                reports)
              </li>
              <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
            ...
            <ul className="list-disc pl-12" style={{ color: "var(--text)" }}>
              ...
              <li>Anonymous-to-KYC levels to Gov’t</li>
              <li>
        ...
        <div className="text-left mb-5 pl-10">
          ...
          <p className="mb-20 ">
            ...
            though for now, this matrix is asking for a generic
            &quot;before&quot; and &quot;after&quot; result based on your
            judgment.
          </p>
        </div>
      </div>
